...
public class MailUtils {
	...
	private static String password = "itcast201707"; // 邮箱授权码(不是邮箱密码，是 授权码的密码）
	//邮箱登录密码：itcast2017
...
//		}
	...
	public static void main(String[] args) throws Exception{
		sendMail("测试邮件", "你好，传智播客<a href='http://www.baidu.com'>我是超链接</a>2017-10-17", "caiwenwen@itcast.cn");
	}
}
